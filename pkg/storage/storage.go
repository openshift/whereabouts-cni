...
type OverlappingRangeStore interface {
	GetOverlappingRangeIPReservation(ctx context.Context, ip net.IP, podRef string) (*v1alpha1.OverlappingRangeIPReservation, error)
	UpdateOverlappingRangeAllocation(ctx context.Context, mode int, ip net.IP, podRef, ifName string) error
}
